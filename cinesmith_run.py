...
logger = logging.getLogger("CinesmithMaster")
...
class CinesmithOrchestrator:
    ...
    async def run_full_production(self, idea: str, project_name: str = None):
        ...
        logger.info("="*60)
        logger.info(f"🚀 CINESMITH PRODUCTION STARTING: '{idea}'")
        logger.info("="*60)
...
async def main():
    parser = argparse.ArgumentParser(description="Cinesmith Master Orchestrator")
    ...
    orchestrator = CinesmithOrchestrator(hosts=args.hosts)
