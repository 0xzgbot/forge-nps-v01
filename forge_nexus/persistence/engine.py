...
from forge_nexus.persistence.search import BM25Searcher

class SearchEngine:
    """
    Orchestrates the integration between SQLite and BM25 for 
    high-speed semantic retrieval of Forge assets.
    """
    def __init__(self, project_path: Path):
        self.project_path = project_path
        self.db_path = self.project_path / ".forge-nexus" / "forge.db"
