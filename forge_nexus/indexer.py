...
try:
    from forge_nexus.parsers.comfyui import ComfyUIParser
    from forge_nexus.parsers.prompts import PromptParser
    from forge_nexus.parsers.characters import CharacterParser
except ImportError:
...
class ManifestIndexer:
    def __init__(self, project_path: Path):
        ...
        self.manifest_dir = self.project_path / ".forge-nexus" / "manifests"
