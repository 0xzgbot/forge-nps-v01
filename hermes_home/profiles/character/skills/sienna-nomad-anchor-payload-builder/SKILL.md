...
```bash
python3 ~/Desktop/Sienna_Nomad_Project/build_payloads.py
```
...
python3 ~/Desktop/Sienna_Nomad_Project/submit_to_comfyui.py --type image

# Step 2 — videos (run later when LTX workflow is configured):
python3 ~/Desktop/Sienna_Nomad_Project/submit_to_comfyui.py --type video
```
...
## Project layout
- Prompts: `~/Desktop/Sienna_Nomad_Project/04_Prompt_Library/`
- Each episode: `EP##_Name/` with `JSON_PAYLOADS/` subfolder
- Workflow template: `~/workflows/hermes_z_image_turbo_api.json`
- Build log: `~/Desktop/Sienna_Nomad_Project/build_log.txt`
- Submit log: `~/Desktop/Sienna_Nomad_Project/submit_log.txt`
