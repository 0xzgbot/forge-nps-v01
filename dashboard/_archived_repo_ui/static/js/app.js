...
window.VIEWS.settings = async () => {
  ...
  row2.append(h('div', { class: 'card setting-group col gap-2', style: 'flex:1;', 'data-accent': 'green' },
    ...
    h('div', { class: 'comfy-slot', style: 'display:flex;gap:6px;align-items:center;' },
      ...
      h('input', { class: 'input comfy-host-input', value: config.comfy_primary || '', id: 'comfy-primary', placeholder:'localhost:8188', style: 'flex:1;' }),
    ...
    h('div', { class: 'comfy-slot', style: 'display:flex;gap:6px;align-items:center;' },
      ...
      h('input', { class: 'input comfy-host-input', value: config.comfy_secondary || '', id: 'comfy-secondary', placeholder:'localhost:8189', style: 'flex:1;' }),
  ...
  row2.append(h('div', { class: 'card setting-group col gap-2', style: 'flex:1;', 'data-accent': 'magenta' },
    ...
    h('div', { class: 'setting-row' },
      ...
      h('input', { class: 'input', value: config.spark_url || '', id: 'spark-url', placeholder: 'http://localhost:8188' }),
      h('button', { class: 'btn btn-sm', onclick: async function() {
