...
@app.get("/")
async def get_index():
    return FileResponse("~/Desktop/forge_nps_v01/dashboard/static/index.html")
...
app.mount("/static", StaticFiles(directory="~/Desktop/forge_nps_v01/dashboard/static"), name="static")
