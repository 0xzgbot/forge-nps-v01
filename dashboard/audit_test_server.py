...
RENDER_DIR = Path("~/Desktop/forge_nps_v01/dashboard/static/renders/sienna")
ANCHOR_PATH = Path("~/Desktop/forge_nps_v01/data/character_banks/anchors/elara_vance.jpg")
