...
class TestCinematicEngine(unittest.TestCase):
    def setUp(self):
        ...
        self.lighting_bank = "/Users/zgbot/Desktop/forge_nps_v01/data/character_banks/lighting_bank.txt"
        self.engine = CinematicEngine(self.lighting_bank)
        self.loader = LibraryLoader("/Users/zgbot/Desktop/forge_nps_v01/data/prompt_libraries/")
