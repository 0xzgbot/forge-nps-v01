...
class TestKimiNarrativeMode(unittest.IsolatedAsyncioTestCase):
    ...
    async def asyncTearDown(self):
        ...
        log_dir = f"~/Desktop/forge_nps/data/reasoning_logs/{self.session_id}"
    ...
    async def test_direct_with_narrative_flow(self, mock_post):
        ...
        expected_log = f"~/Desktop/forge_nps/data/reasoning_logs/{self.session_id}/full_analysis_reasoning.md"
