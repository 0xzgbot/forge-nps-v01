...
These files are preserved for history only. They are not active setup, runtime, or demo instructions.

Active documentation lives at the repo root:
...
- `2026-04-planning/`: older task plans, workload splits, feature plans, and memory notes from the April build phase.
- `demo/`: older standalone demo scripts now consolidated into `SUBMISSION_GUIDE.md`.
