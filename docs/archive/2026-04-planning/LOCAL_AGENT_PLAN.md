...
**Project root:** `/Users/zgbot/Desktop/forge_nps_v01`  
**Dashboard:** `http://localhost:7000`  
**LM Studio:** `http://100.74.164.1:1234` (Hermes-3 model: `Hermes-3-Llama-3.2-3B`)  
**Kimi API:** NVIDIA NIM at `https://integrate.api.nvidia.com/v1/chat/completions`  
**Spark (ComfyUI):** `http://100.112.87.8:8188`  
**Workflow file:** `/Users/zgbot/workflows/hermes_z_image_turbo_api.json`
...
```python
    async def generate(
        ...
        workflow_path = pathlib.Path("/Users/zgbot/workflows/hermes_z_image_turbo_api.json")
