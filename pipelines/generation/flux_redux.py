...
WORKFLOW_PATH = "~/Desktop/forge_nps/workflows/flux_redux_api.json"
...
class FluxReduxGenerator:
    ...
    def generate_with_redux(self, project_slug, character_key, prompt_text, output_name, 
        ...
        ref_image_path = f"~/Desktop/forge_nps/projects/{project_slug}/assets/head_sheet.png"
        ...
        save_path = f"~/Desktop/forge_nps/projects/{project_slug}/generations/anchors/{encoded_filename}"
