...
def get_project_data(slug):
    path = f"/Users/zgbot/Desktop/forge_nps/projects/{slug}/PROJECT.md"
...
def load_banks(slug):
    banks = {}
    dir_path = f"/Users/zgbot/Desktop/forge_nps/projects/{slug}/banks"
...
def main():
    ...
    client = comfy_client.ComfyClient(host="100.74.164.1", port=GPU_PORT)
    output_dir = f"/Users/zgbot/Desktop/forge_nps/projects/{slug}/assets/training_images"; os.makedirs(output_dir, exist_ok=True)
