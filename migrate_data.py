...
def migrate_banks(src_templates, dest_dir):
    ...
    for txt_file in src_path.glob("*.txt"):
        ...
        # ~/Desktop/forge_nps/templates/character_banks/lighting_bank.txt
...
if __name__ == "__main__":
    PROMPT_SRC = "~/Desktop/forge_nps/projects/prompt_libraries/"
    PROMPT_DEST = "~/Desktop/forge_nps/data/prompt_libraries/"
    BANK_SRC = "~/Desktop/forge_nps/templates/character_banks/"
    BANK_DEST = "~/Desktop/forge_nps/data/character_banks/"
