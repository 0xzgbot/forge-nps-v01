...
async def run_memory_demo():
    ...
    mem_dir = f"/Users/zgbot/Desktop/forge_nps_v01/data/hermes_memory/{session_id}"
...
async def run_demo(script_path: str, mock: bool, dashboard: bool, idea: Optional[str] = None, mock_failure: bool = False):
    ...
    real_auditor = ContinuityAuditor(lore_bible_path="/Users/zgbot/Desktop/forge_nps_v01/data/lore_bible/world_bible.md")
    ...
    if idea:
        ...
        lore_paths = ["/Users/zgbot/Desktop/forge_nps_v01/data/lore_bible/world_bible.md"]
...
if __name__ == "__main__":
    ...
    parser.add_argument("--script", type=str, default="/Users/zgbot/Desktop/forge_nps_v01/scripts/demo/pilot_script.md", help="Path to the pilot script")
