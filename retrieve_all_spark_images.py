...
OUTPUT_DIRS = {
    "FLUX2_TURBO": "~/Desktop/projects/Sienna_Nomad_Project/RENDERED_OUTPUT",
    "Prompt_": "~/Desktop/projects/Sienna_Nomad_Project/RENDERED_OUTPUT",
    "SPARK_TEST": "~/Desktop/projects/Sienna_Nomad_Project/RENDERED_OUTPUT",
    "HACKATHON_": "~/Desktop/projects/hackathon_vid/04_assets",
    "Flux2_dev": "~/Desktop/projects/Sienna_Nomad_Project/RENDERED_OUTPUT",
}
...
def determine_output_dir(filename):
    ...
    for prefix, path in OUTPUT_DIRS.items():
        if prefix in filename:
            return path
    return "~/Desktop/projects/Sienna_Nomad_Project/RENDERED_OUTPUT"
