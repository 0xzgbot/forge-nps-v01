...
```
┌─────────────────────────────────────────────────────────────┐
│  [LOGO]  FORGE NPS        Home  Characters  Script  Products  Renders  Memory  Settings  │
├─────────────────────────────────────────────────────────────┤
│                                                             │
...
│                                                             │
│  [MODEL CONFIG]                                             │
│  FLUX2 Model:     [flux2-dev-nvfp4.safetensors]           │
│  CLIP Model:      [mistral_3_small_flux2_bf16.safetensors]│
│  Turbo LoRA:      [Flux_2-Turbo-LoRA_comfyui.safetensors] │
│                                                             │
│  [BANK EDITOR]                                              │
...
| Icons | SVG/IconFont | System, characters, script, products, renders, memory, settings, play, stop, refresh, download, copy, search, filter, expand, collapse |
...
| **P5** | Settings tab (config editor) | 1 hr |
| **P6** | Products tab | 1 hr |
| **P7** | Polish: animations, responsive, empty states, iconography | 2-3 hrs |
